...
// ===== 10-style.js =====
  function ensureStyle() {
    ...
    tag.textContent = [
      `#${ITEM_ID}{cursor:pointer;position:relative;left:0;top:0;width:100%;height:${PINNED_HEIGHT}px;z-index:3;box-sizing:border-box;padding:0;border:0;background:transparent !important;box-shadow:none !important;}`,
      `#${ITEM_ID}::before,#${ITEM_ID}::after{display:none !important;}`,
      `#${ITEM_ID} .mail-pin-shell{height:100%;padding:10px 14px 10px 20px;border-radius:16px;border:1px solid var(--zmail-accent-soft,rgba(37,99,235,.18));background:linear-gradient(135deg,var(--zmail-accent-soft,rgba(37,99,235,.14)),rgba(14,165,233,.08));display:flex;}`,
      `#${ITEM_ID}[data-active="1"] .mail-pin-shell{background:linear-gradient(135deg,var(--zmail-accent-soft,rgba(37,99,235,.24)),rgba(14,165,233,.16));border-color:var(--zmail-accent-soft,rgba(37,99,235,.34));}`,
      `#${ITEM_ID} .mail-pin{height:100%;padding:0;display:flex;flex-direction:column;justify-content:center;gap:3px;min-width:0;}`,
      ...
      `.${MAIN_MARKER} .mail-card{background:var(--zmail-surface,var(--layer-background,#fff)) !important;border:1px solid var(--zmail-border,rgba(148,163,184,.24)) !important;border-radius:20px;box-shadow:0 18px 36px var(--zmail-shadow,rgba(15,23,42,.08));display:flex;flex-direction:column;min-height:0;min-width:0;overflow:hidden;}`,
      ...
      `.${MAIN_MARKER} .mail-btn{border:1px solid var(--zmail-border,rgba(148,163,184,.28)) !important;border-radius:10px;padding:8px 12px;background:var(--zmail-surface-2,#e2e8f0) !important;color:var(--zmail-text,var(--text-primary,#0f172a)) !important;font-size:12px;font-weight:700;cursor:pointer;max-width:100%;} .${MAIN_MARKER} .mail-btn.pri{background:var(--zmail-accent,#2563eb) !important;border-color:var(--zmail-accent,#2563eb) !important;color:#fff !important;} .${MAIN_MARKER} .mail-btn.ghost{background:var(--zmail-surface,var(--layer-background,#fff)) !important;border:1px solid var(--zmail-border,rgba(148,163,184,.28)) !important;} .${MAIN_MARKER} .mail-btn:disabled{opacity:.55;cursor:wait;}`,
      ...
      `.${MAIN_MARKER} .mail-folder-list,.${MAIN_MARKER} .mail-list{display:flex;flex-direction:column;gap:8px;min-width:0;} .${MAIN_MARKER} .mail-folder,.${MAIN_MARKER} .mail-row{padding:12px 14px;border-radius:16px;background:var(--zmail-surface,var(--layer-background,#fff)) !important;border:1px solid var(--zmail-border,rgba(148,163,184,.18)) !important;cursor:pointer;min-width:0;text-align:left;color:var(--zmail-text,var(--text-primary,#0f172a)) !important;}`,
      `.${MAIN_MARKER} .mail-folder.active,.${MAIN_MARKER} .mail-row.active{background:linear-gradient(135deg,var(--zmail-accent-soft,rgba(37,99,235,.12)),rgba(14,165,233,.08)) !important;border-color:var(--zmail-accent-soft,rgba(37,99,235,.34)) !important;} .${MAIN_MARKER} .mail-folder{display:flex;justify-content:space-between;gap:8px;align-items:center;} .${MAIN_MARKER} .mail-badge{min-width:26px;height:26px;border-radius:999px;background:var(--zmail-accent-soft,rgba(37,99,235,.12)) !important;color:var(--zmail-accent,#1d4ed8) !important;display:inline-flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;flex:0 0 auto;}`,
